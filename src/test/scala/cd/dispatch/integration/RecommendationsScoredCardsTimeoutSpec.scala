...
object RecommendationsScoredCardsTimeoutSpec extends ZIOSpecDefault {
  ...
  val upstreamResponseConfigWithScoredCardTimeout: UpstreamResponseConfig = UpstreamResponseConfig(List(call1, scoredCardsRespnseWithTimeout))
  val appConfigWithScoredCardsTimeout: AppConfig = appConfig.copy(upstreamResponse = upstreamResponseConfigWithScoredCardTimeout)
